...
import (
	...
	"github.com/soub4i/kubeststus-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "0dad518f.soubai.me",
	...
	if err = (&controller.KubeStatusReconciler{
		...
		Recorder: mgr.GetEventRecorderFor("kubestatus-controller"),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "KubeStatus")
		os.Exit(1)
	}
